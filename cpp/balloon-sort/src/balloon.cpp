...
int main()
{
	...
	// Input representation preference
	do
	{
		std::cout << "How would you like the representation be (G|P): ";
		std::cin >> rep;
	} while( ! repIsValid(rep) );
