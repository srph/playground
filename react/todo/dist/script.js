...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddForm = __webpack_require__(177);
	var SearchForm = __webpack_require__(196);
	var TodoList = __webpack_require__(197);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var tasks = filter.length === 0 ? this.state.tasks : this.state.tasks.filter(function (task) {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(AddForm, { onAdd: this.handleAdd }),
	      React.createElement(SearchForm, { onSearch: this.handleSearch }),
	      React.createElement(TodoList, { tasks: tasks, onDelete: this.handleDelete })
	    );
	  },

	  handleAdd: function handleAdd(task) {
	    var tasks = this.state.tasks;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(172).setImmediate, (function() { return this; }()), __webpack_require__(173)(module)))
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.title,
	        React.createElement('input', { name: 'title', type: 'text', placeholder: 'Enter task title..', valueLink: this.linkState('title') }),
	        this.state.priority,
	        React.createElement(
	          'select',
	          { name: 'priority', valueLink: this.linkState('priority') },
	          React.createElement(
	            'option',
	            { value: '1' },
	            'Low'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTransitionGroup = React.createFactory(__webpack_require__(185));
	var ReactCSSTransitionGroupChild = React.createFactory(__webpack_require__(190));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(11);
	var ReactPropTransferer = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoListPriority = __webpack_require__(198);
	var TodoListDeleteButton = __webpack_require__(199);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return tasks.length > 0 ? React.createElement(
	      'div',
	      null,
	      tasks.map(function (task, i) {
	        return React.createElement(
	          ...
	          { key: i },
	          task.title,
	          React.createElement(TodoListPriority, { priority: task.priority }),
	          React.createElement(TodoListDeleteButton, { onDelete: onDelete, index: i })
	        );
	      })
	    ) : React.createElement(
	      'div',
